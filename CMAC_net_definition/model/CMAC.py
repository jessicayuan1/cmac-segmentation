...
class CMACNet(nn.Module):
    """
    PyTorch Class Definition for CMACNet.
    Implemented as close as possible to model described in: 
    https://www.sciencedirect.com/science/article/pii/S1746809425009954?via%3Dihub
    """
    def __init__(
        self,
        in_channels = 3,
